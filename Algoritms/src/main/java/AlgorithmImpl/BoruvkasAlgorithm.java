...
//        List<Edge> edges = initialGraph.getEdges();
//
//        int count = 1;
...
//    }
//
//    private static void removeInnerComponentEdges(Set<Component> components, List<Edge> edges) {
//        for (Component component : components) {
//            removeInnerComponentEdges(component, edges);
//        }
//    }
//
//    private static void removeInnerComponentEdges(Component component, List<Edge> edges) {
...
//    }
//
//    private static Edge findMinimumWeightEdgeForComponent(Component component, List<Edge> edges) {
...
//    }
//
//    private static Edge findMinimumWeightEdgeForSrcVertex(int vertex, List<Edge> edges) {
//        Edge minEdge = edges.stream()
